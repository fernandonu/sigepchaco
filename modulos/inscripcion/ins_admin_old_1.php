  ...
  if($responsable =='MADRE'){
         ...
         where id_beneficiarios=".$id_planilla;
  		 ...
  		 if ($id_categoria=='1') {
			 ...
			 tipo_ficha='1', tipo_transaccion='M'
       ...
       <td>
		...
		<tr>
         ...
         <tr>
		    ...
		    <td align="left">
		    	<input type=text name=fecha_nac onblur="esFechaValida(this);" value='<?=$fecha_nac;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
		...
		<tr>
         ...
         <tr>	           
          ...
          <tr>
		    ...
		    <td align="left">	       
		    	 <input type=text name=fecha_diagnostico_embarazo onblur="esFechaValida(this);" value='<?=$fecha_diagnostico_embarazo;?>' <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?> size=15>
		...
		<tr>
		    ...
		    <td align="left">
		    	 ...
		    	 <input type=text name=fecha_probable_parto onblur="esFechaValida(this);" value='<?=$fecha_probable_parto;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         ...
         <tr>
		    ...
		    <td align="left" colspan="2">
		    	 <input type=text name=fecha_inscripcion onblur="esFechaValida(this);" value='<?=$fecha_inscripcion;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
