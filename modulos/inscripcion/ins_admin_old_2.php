...
if ($_POST['guardar_editar']=="Guardar"){
  ...
  if($responsable =='MADRE'){
             ...
             nro_doc_tutor='',tipo_doc_tutor='', tipo_transaccion='M', estado_envio='n'
   		...
   		$query = "update uad.beneficiarios set 
             ...
             apellido_tutor='', nro_doc_tutor='',tipo_doc_tutor='', tipo_transaccion='M', estado_envio='n'                        
         ...
         where id_beneficiarios=".$id_planilla;
             ...
             apellido_padre='', nro_doc_padre='',tipo_doc_padre='', tipo_transaccion='M', estado_envio='n'                              
  		 ...
  		 if ($id_categoria=='1') {
			 ...
			 tipo_ficha='1', tipo_transaccion='M', estado_envio='n'
       ...
       <td>
        <table class="bordes" align="center">                          
         ...
         <tr>
            ...
            <td align='left'>
              <input type="text" size="30" value="<?=$apellido?>" name="apellido" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>
           	<td align="right">
         	  <b>Nombre:</b>
         	</td>         	
            <td align='left'>
              <input type="text" size="30" value="<?=$nombre?>" name="nombre" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>
         </tr> 
		...
		<tr>
         ...
         <tr>
		    ...
		    <td align="left">
		    	<input type=text name=fecha_nac id=fecha_nac onblur="esFechaValida(this);" value='<?=$fecha_nac;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
		...
		<tr>
         ...
         <tr  align="center">
         	<td align="right" width="20%" colspan="2">
				<b>Categoria del Beneficiario:</b>
			</td>
         ...
         <tr>
          ...
          <tr>
            ...
            <td align='left' width="30%">
              <input type="text" size="30" value="<?=$nro_doc_madre?>" name="nro_doc_madre" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>            
         </tr>
         ...
         <tr>
            ...
            <td align='left'>
              <input type="text" size="30" value="<?=$apellido_madre?>" name="apellido_madre" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>
           	<td align="right">
         	  <b>Nombre:</b>
         	</td>         	
            <td align='left'>
              <input type="text" size="30" value="<?=$nombre_madre?>" name="nombre_madre" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>
         </tr> 
         <tr>	           
         ...
         <tr>	           
          ...
          <tr>
		    ...
		    <td align="left">	       
		    	 <input type=text name=fecha_diagnostico_embarazo id=fecha_diagnostico_embarazo onblur="esFechaValida(this);" value='<?=$fecha_diagnostico_embarazo;?>' <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?> size=15>
            ...
            <td align='left'>
            	...
            	<input type="text" name="semanas_embarazo"  value=<?=$semanas_embarazo;?> onblur="recalcF1()"  size="30"  <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>		    
		</tr>   
		...
		<tr>
		    ...
		    <td align="left">
		    	 ...
		    	 <input type=text name=fecha_probable_parto id=fecha_probable_parto onblur="esFechaValida(this);" value='<?=$fecha_probable_parto;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         ...
         <tr>	           
           <td align="center" colspan="4" id="ma">
            ...
            <td align='left'>
		    	...
		    	<input type=text id=fecha_efectiva_parto name=fecha_efectiva_parto onblur="esFechaValida(this);" value='<?=$fecha_efectiva_parto;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         ...
         <tr>
		    ...
		    <td align="left" colspan="2">
		    	 <input type=text name=fecha_inscripcion id=fecha_inscripcion onblur="esFechaValida(this);" value='<?=$fecha_inscripcion;?>' size=15 <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         ...
         <tr>
            ...
            <td align='left'>
              <input type="text" size="30" value="<?=$calle?>" name="calle" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
            </td>
           	<td align="right">
         	  <b>Numero Calle:</b><input type="text" size="5" value="<?=$numero_calle?>" name="numero_calle" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         	</td>         	
            <td align='left'>
			  <b>Piso:</b><input type="text" size="5" value="<?=$piso?>" name="piso" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
            </td>
         </tr>  
         ...
         <tr>
         	<td align="right">
         	  <b>Depto:</b>
         	  <input type="text" size="10" value="<?=$dpto?>" name="dpto" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         	</td>         	
            <td align='left'>
			  <b>Mz:</b>
         	  <input type="text" size="10" value="<?=$manzana?>" name="manzana" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
            </td>
         	<td align="right">
         	  <b>Entre Calle:</b><input type="text" size="10" value="<?=$entre_calle_1?>" name="entre_calle_1" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         	</td>         	
            <td align='left'>
			  <b>Entre Calle:</b>
         	  <input type="text" size="10" value="<?=$entre_calle_2?>" name="entre_calle_2" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
            </td>         	
         </tr>  
         ...
         <tr>
            ...
            <td align='left'>
         	  <input type="text" size="30" value="<?=$telefono?>" name="telefono" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
            </td>
            <!-- Ajax -->
  <tr>
    <td align="right">
