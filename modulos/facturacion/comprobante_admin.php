...
if ($entidad_alta=='nu'){//carga de prestacion a paciente NO PLAN NACER
	$link=encode_link("comprobante_admin_total.php", array("id"=>$id_smiafiliados,"pagina_viene"=>"comprobante_admin.php","pagina_listado"=>$pagina_listado));?>
	 ...
	 <?}
	 	...
	 	while (!$res_comprobante->EOF) {
	 		...
	 		<tr <?=atrib_tr()?>>
		 		...
		 		<td onclick="<?=$onclick_marcar?>" align="center"><?if ($res_comprobante->fields['marca']==1){echo "<img src='../../imagenes/salir.gif' style='cursor:hand;'>";}
		 											else if ($res_comprobante->fields['id_factura']!="") {echo "Facturado";}
		 											else echo "<img src='../../imagenes/sin_desc.gif' style='cursor:hand;'>"?></td>		 		
		 	</tr>	
		 	<tr>
	          <td colspan=9>
