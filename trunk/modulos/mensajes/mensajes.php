...
<div class="newstyle-full-container">
	...
	<div class="row-fluid options-btn-bar">
		<div class="span8">
			<div class="btn-group">
				<input id="btn-nuevo" class="btn" type="submit" name="boton" value="Nuevo Mensaje">
				<input id="btn-reenviar" class="btn" type="submit" name="boton" value="Reenviar" onClick="return comprueba();">
				<input id="btn-borrar" class="btn" type="submit" name="boton" value="Borrar" onClick="return borrar();">
			</div>
		</div>
		<div class="span4">
			<!--
		...
		<tr>
			...
			<td>
				<?php
					...
					if($urgencia==2) {
						echo "   <span class='badge badge-important'>Vencido</span>";
					} else {
						if ($urgencia==1) {
							echo "   <span class='badge badge-warning'>Por Vencer</span>";
						}
					}
				?>
			</td>
