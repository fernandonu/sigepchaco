...
function afiactivo($afiactivo) {
	$this->SetFont('Arial','B',18);
	$this->setxy(165,$this->recuperar_base1()+47);
	$this->cell(5,9,"Activo: $afiactivo");
}

function manrodoc($manrodoc) {
	$this->SetFont('Arial','B',12);
	$this->setxy(7,$this->recuperar_base1()+50);
	$this->cell(5,9,"DNI Responsable: $manrodoc");
}

function manom($manom) {
	$this->SetFont('Arial','B',12);
	$this->setxy(75,$this->recuperar_base1()+50);
	$this->cell(5,9,"Nombre Responsable: $manom");
}
...
function mes_ano($periodo) {
$this->setxy(7,$this->recuperar_base1()+45);
$this->cell(200,5,'Periodo: '.$periodo);
}
...
function dibujar_planilla($vencimiento) {
	...
	$this->setxy(7,$this->recuperar_base1()+58);
