...
<table border=0 width=100% cellspacing=2 cellpadding=2 bgcolor='<?=$bgcolor3?>' align=center>
 ...
 <?if ($_POST['buscar']){
   while (!$result->EOF) {
   	$ref = encode_link("comprobante_admin.php",array("id_smiafiliados"=>$result->fields['id_smiafiliados'],"clavebeneficiario"=>$result->fields['clavebeneficiario'],"pagina_listado"=>"listado_beneficiarios_hist.php","estado"=>$result->fields['activo']));
