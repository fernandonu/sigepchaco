...
if ($_POST['guardar']=="Guardar Planilla"){
   ...
   $fpcp=Fecha_db($fpcp);
    ...
    $query="insert into trazadoras.embarazadas
             ...
             sem_gestacion,fum,fpp,fpcp,observaciones,fecha_carga,usuario,vdrl,antitetanica,id_comprobante)
             values
             ('$id_planilla','$cuie','$clave','$tipo_doc','$num_doc','$apellido',
             '$nombre','$fecha_control','$sem_gestacion','$fum',
             '$fpp','$fpcp','$observaciones','$fecha_carga','$usuario','$vdrl','$antitetanica','$id_comprobante')";
