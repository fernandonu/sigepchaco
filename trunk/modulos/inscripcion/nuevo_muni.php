...
$c="select id_codpos from uad.codpost where id_localidad=$id_localidad";
$codipos = sql($c) or fin_pagina();
$id_codpos = $codipos->fields['id_codpos'];
...
if ($_POST['guardar']=='Guardar'){
	...
	if($res_very->recordCount()==0){
			   ...
			   $db->CompleteTrans();   
	} else {$accion= "Ya existe un Municipio con ese nombre";}
...
<input type="hidden" name="id_codpos" value="<?=$id_codpos?>">
