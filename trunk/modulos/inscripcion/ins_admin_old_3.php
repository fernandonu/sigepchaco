...
if ($_POST['transferir']=="Transferir"){
	 ...
	 $query = "update uad.beneficiarios set tipo_ficha='2', activo='1', estado_envio='n', id_categoria='6' where id_beneficiarios=".$id_planilla;
	 sql($query, "Error al transferir el muleto") or fin_pagina();
	 }
 	  if (($id_categoria == '3') || ($id_categoria == '4')) {
	 $query = "update uad.beneficiarios set tipo_ficha='2', activo='1', estado_envio='n', id_categoria='5' where id_beneficiarios=".$id_planilla;
	 sql($query, "Error al transferir el muleto") or fin_pagina();
	 }  
	 $db->CompleteTrans();    
...
$sql1="select * from uad.beneficiarios	  
		...
		if (($res_extra1->recordcount()>0) && ($clase_doc=='P')){
	...
	$observaciones=$res_extra1->fields['observaciones'];   	
		...
		}elseif (($res_extra1->recordcount()>0) && ($clase_doc=='A') || ($clase_doc=='P')) {
        ...
        <td colspan="4" align="center" id="cdomi" style="display:<?=$cdomi1?>">
         ...
         <tr>
            ...
            <td align='left'>
         	...
         	<td align="right">
         	  <b>Entre Calle:</b><input type="text" size="10" value="<?=$entre_calle_1?>" name="entre_calle_1" onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>
         	</td>         	
            <td align='left'>
			  <b>Entre Calle:</b>
         	  <input type="text" size="10" value="<?=$entre_calle_2?>" name="entre_calle_2" onkeypress="return pulsar(event)" <?php if (($id_planilla) and ($tipo_transaccion != "M"))echo "disabled"?>>         	
            </td>         	
         </tr>  
