...
$html_header = "<html>
					<head>
						...
						<link rel=stylesheet type='text/css' href='$html_root/newstyle/css/main.css'>
						...
						<link rel=stylesheet type='text/css' href='$html_root/newstyle/css/smoothness/jquery-ui-1.8.23.custom.css'>
						<script languaje='javascript' src='$html_root/newstyle/js/jquery-ui-1.8.23.custom.min.js'>
						...
						<script language='javascript'>
							...
							function check_fix_size() {
								...
								if(parent && parent.oPath && $actualizar_menu_perfil_usuario) parent.oPath.updateLink();
								//actualiza el link del menu actual 
							}
